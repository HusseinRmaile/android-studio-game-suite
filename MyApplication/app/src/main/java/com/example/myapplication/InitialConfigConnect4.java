...
public class InitialConfigConnect4 extends AppCompatActivity{
    ...
    public static Connect4Player player1 = new Connect4Player(1);
    public static Connect4Player player2 = new Connect4Player(2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.initial_config_connect4);
        ...
        storeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (invalid1) {
                    ...
                    Intent intent = new Intent(InitialConfigConnect4.this, Connect4.class);
